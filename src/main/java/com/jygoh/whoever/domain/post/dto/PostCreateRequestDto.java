...
public class PostCreateRequestDto {
    ...
    @Builder
    public PostCreateRequestDto(String title, String content, List<String> hashtagNames, Long categoryId) {
        this.title = title;
    ...
    public Post toEntity(Long authorId, String thumbnailUrl, Set<Long> hashtagIds, Long categoryId) {
